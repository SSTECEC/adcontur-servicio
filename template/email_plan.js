...
function email_plan(nombre, plan, precio, email, telefono, ventas, compras, afiliados) {
    return `<!DOCTYPE html
                            ...
                            <tr>
                                <td class="inner contents"
                                    ...
                                    <p class="h4 center grey"
                                        ...
                                        Felicitaciones, el cliente <b style="color: #13683b !important"> `+
        nombre + `</b> a solicitado comprar un plan de servicios.
                                    </p>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <div style="padding-left: 80px !important; padding-right: 80px !important">
                                        <table border="0"
                                            ...
                                            <tr>
                                                <td
                                                    style="width: 50% !important;padding-top:5px;padding-bottom:5px;padding-right:10px;padding-left:10px;">
                                                    <b>Ventas Aproximadas al Mes:</b></td>
                                                <td
                                                    style="width: 50% !important;padding-top:5px;padding-bottom:5px;padding-right:10px;padding-left:10px;">
                                                    `+ ventas + `
                                                </td>
                                            ...
                                            <tr>
                                                <td
                                                    style="width: 50% !important;padding-top:5px;padding-bottom:5px;padding-right:10px;padding-left:10px;">
                                                    <b>Compras Aproximadas al Mes:</b></td>
                                                <td
                                                    style="width: 50% !important;padding-top:5px;padding-bottom:5px;padding-right:10px;padding-left:10px;">
                                                    `+ compras + `
                                                </td>
